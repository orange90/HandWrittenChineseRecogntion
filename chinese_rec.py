...
tf.app.flags.DEFINE_string('train_data_dir', '../data1/train/', 'the train dataset dir')
tf.app.flags.DEFINE_string('test_data_dir', '../data1/test/', 'the test dataset dir')
...
def train():
    ...
    train_feeder = DataIterator(data_dir='../data1/train/')
    test_feeder = DataIterator(data_dir='../data1/test/')
...
def main(_):
    ...
    if FLAGS.mode == "train":
        ...
        image_path = '../data1/test/00190/13320.png'
